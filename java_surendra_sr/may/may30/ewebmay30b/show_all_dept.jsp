...
<%@include file="sis_header.jsp" %>
	...
	<div id="content_section">
	 ...
	 <%if(request.getParameter("delete_msg")!=null){ %>
	    Department deleted....
	 <%} %>
	 <%if(request.getParameter("add_msg")!=null){ %>
	...
	<%for(Department dept:deptList){ %>
	 <tr>
	   ...
	   <td> 
	      <a href="dept_update.jsp?id=<%=dept.getId()%>">update</a> &nbsp;&nbsp;
	      <a href="dept_delete.jsp?id=<%=dept.getId()%>" class="delete"> <img alt="" src="imgs/delete.png"> delete</a> 
	   </td>
	 </tr>
	 <%} %>
