 ...
 */
 ...
 public class Part2ShowServlet extends GenericServlet{ 
 public   void service(ServletRequest request, ServletResponse response) 
			throws  ServletException, IOException{
			String deptStr  = request.getParameter("dept_no");
			long deptNumber  = Long.parseLong(deptStr);
			...
			PrintWriter  pw  = response.getWriter();
			  ...
			  try{
				  ...
				  String sql  ="select * from emp where deptno="+deptNumber;
