...
public class MyService3  extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		htmlCode.append("<h1>This is Service3</h1><hr>");
		...
		htmlCode.append("<a href='s4'>go to Service4</a><hr>");
		htmlCode.append("<a href='s4?client_name="+userName+"&client_time="+userTime+"'>go to Service4 (URLREWRITE)</a><hr>");
