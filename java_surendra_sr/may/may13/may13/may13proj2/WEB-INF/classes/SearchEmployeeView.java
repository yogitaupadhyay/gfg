...
public class SearchEmployeeView extends GenericServlet{
	...
	public void service(ServletRequest request, ServletResponse response) 
		...
		htmlCode.append("<h1>Given Search text <span style='color:red;'> '"+request.getParameter("emp_search_text_name")+"'</span></h1>");
		...
		pw.print(htmlCode);
		htmlCode.append("<fieldset><legend>search</legend>");
		//htmlCode.append("<a href='emp_search_form.html'>back to emp search</a><hr>");
		request.getRequestDispatcher("emp_search_form.html").include(request, response);
