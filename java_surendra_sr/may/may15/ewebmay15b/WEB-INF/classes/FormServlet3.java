...
public class FormServlet3  extends HttpServlet{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		htmlCode.append("<h1>Student form Final Step</h1><hr>");
		
		htmlCode.append("<form method='post' action='fs4'>");
		...
		htmlCode.append("<input type='hidden' name='stu_gender'     value='"+gender+"'>");
		htmlCode.append("<input type='hidden' name='stu_college_name'     value='"+college+"'>");
		
		htmlCode.append("email :<input type='text' name='stu_email'><br>");
		htmlCode.append("mobile :<input type='text' name='stu_mobile'><br>");
		htmlCode.append("<input type='submit' value='Finish'>");
