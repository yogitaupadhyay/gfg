 ...
 */
 ...
 public class ShowAllStudentServlet extends GenericServlet{ 
			  ...
			  try{
				  ...
				  rs  = stmt.executeQuery(sql);
					  while(rs.next()){
						  ...
						  pw.print("<td>");
						  pw.print("<a href=\'deletestu?id="+id+"\'>delete</a><br>");
						  pw.print("<a href=\'updateForm?id="+id+"\'>update</a>");
						  pw.print("</td>");
						  pw.print("</tr>");
