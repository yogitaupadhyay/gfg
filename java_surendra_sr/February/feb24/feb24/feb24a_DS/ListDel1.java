...
public class ListDel1 {
	...
	public static void main(String[] args) {
		...
		stuList1.add(new String("meena"));
		 ...
		 System.out.println("remove mukesh");
		 System.out.println(stuList1.remove("mukesh"));
		 System.out.println("stuList1 = "+stuList1);
	 
 
		System.out.println("remove surendra");
		 System.out.println(stuList1.remove("surendra"));
		 System.out.println("stuList1 = "+stuList1);
